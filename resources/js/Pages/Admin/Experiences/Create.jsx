...
export default function Create() {
    ...
    return (
        <AdminLayout header="Create Experience">
            <Head title="Admin - Create Experience" />
                ...
                <div className="max-w-2xl mx-auto">
                    ...
                    <div className="mb-8">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">
                                {t('experiences.create_new', 'Create New Experience')}
                            </h1>
                            <p className="text-gray-600 dark:text-gray-400">
                                {t('experiences.create_description', 'Add a new work experience to your portfolio')}
                            </p>
                        </div>
                    </div>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                {t('experiences.experience_details_description', 'Enter the information about this work experience')}
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
