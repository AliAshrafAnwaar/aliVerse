...
export default function Create() {
    ...
    return (
        <AdminLayout header="Create Education">
            <Head title="Admin - Create Education" />
                ...
                <div className="max-w-2xl mx-auto">
                    ...
                    <div className="mb-8">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">
                                {t('educations.create_new', 'Create New Education')}
                            </h1>
                            <p className="text-gray-600 dark:text-gray-400">
                                {t('educations.create_description', 'Add a new educational background to your portfolio')}
                            </p>
                        </div>
                    </div>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                {t('educations.education_details_description', 'Enter the information about this educational experience')}
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
